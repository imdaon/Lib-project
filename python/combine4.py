...
def change_password(pwd):  # 비밀번호 바꾸기
    ...
    while 1:
        ...
        if pw == pwd:  # 바꿀 비번이 기본과 똑같을때
            ...
            n_pwd = pw
            break
    num=regist_id.index(pwd)
    c.execute("update userlist set pwd = ? where id = ?",(n_pwd,regist_id[num-1]))
    print('수정완료')  
    time.sleep(1)
    os.system('clear')
    return n_pwd
...
def change_ID(uid):  # 아이디 변경
    ...
    while 1:
        ...
        if ID == uid:  # 바꿀 아이디가 기본과 똑같을때
            ...
            n_ID = ID
            break
    num=regist_id.index(uid)
    c.execute("update userlist set id = ? where id = ?",(n_ID,regist_id[num]))
    print('수정완료')  
    time.sleep(1)
    os.system('clear')
    return n_ID
...
def change_name(name):  
    ...
    while 1:
        ...
        if new_name == name:  
            ...
            n_name = new_name
            break   
    num=regist_id.index(name)
    c.execute("update userlist set name = ? where id = ?",(n_name,regist_id[num-2]))
    print('수정완료')  
    time.sleep(1)
    os.system('clear')
    return n_name
...
def change_num(num):  
    ...
    while 1:
        ...
        if new_num == num:  
            ...
            n_num = new_num
            break   
    num=regist_id.index(num)
    c.execute("update userlist set phone = ? where id = ?",(n_num,regist_id[num-3]))
    print('수정완료')  
    time.sleep(1)
    os.system('clear')
    return n_num
